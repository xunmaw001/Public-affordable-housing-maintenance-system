  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.weihushijian" label="维护时间" prop="weihushijian">
              <el-input v-model="ruleForm.weihushijian" 
                placeholder="维护时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维护人员" prop="weihurenyuan">
          <el-input v-model="ruleForm.weihurenyuan" 
              placeholder="维护人员" clearable  :readonly="ro.weihurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维护人员" prop="weihurenyuan">
              <el-input v-model="ruleForm.weihurenyuan" 
                placeholder="维护人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维护内容" prop="weihuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.weihuneirong" label="维护内容" prop="weihuneirong">
                    <span>{{ruleForm.weihuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="维护结果" prop="weihujieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.weihujieguo" label="维护结果" prop="weihujieguo">
                    <span>{{ruleForm.weihujieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weihushijian = true;
          ...
          if(o=='weihurenyuan'){
            this.ruleForm.weihurenyuan = obj[o];
	    this.ro.weihurenyuan = true;
            continue;
          }
          if(o=='weihuneirong'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fangwuweihu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fangwuweihuCrossAddOrUpdateFlag = false;
						 this.parent.search();
