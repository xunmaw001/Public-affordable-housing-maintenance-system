<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="业主号" prop="yezhuhao">
          <el-input v-model="ruleForm.yezhuhao" 
              placeholder="业主号" clearable  :readonly="ro.yezhuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="业主号" prop="yezhuhao">
              <el-input v-model="ruleForm.yezhuhao" 
                placeholder="业主号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼房号" prop="loufanghao">
          <el-input v-model="ruleForm.loufanghao" 
              placeholder="楼房号" clearable  :readonly="ro.loufanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼房号" prop="loufanghao">
              <el-input v-model="ruleForm.loufanghao" 
                placeholder="楼房号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="师傅姓名" prop="shifuxingming">
          <el-input v-model="ruleForm.shifuxingming" 
              placeholder="师傅姓名" clearable  :readonly="ro.shifuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="师傅姓名" prop="shifuxingming">
              <el-input v-model="ruleForm.shifuxingming" 
                placeholder="师傅姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="师傅手机" prop="shifushouji">
          <el-input v-model="ruleForm.shifushouji" 
              placeholder="师傅手机" clearable  :readonly="ro.shifushouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="师傅手机" prop="shifushouji">
              <el-input v-model="ruleForm.shifushouji" 
                placeholder="师傅手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.huizhidan" label="回执单" prop="huizhidan">
          <file-upload
          tip="点击上传回执单"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.huizhidan?ruleForm.huizhidan:''"
          @change="huizhidanUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.huizhidan" label="回执单" prop="huizhidan">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.huizhidan)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baoxiushebei = true;
          ...
          if(o=='yezhuhao'){
            this.ruleForm.yezhuhao = obj[o];
	    this.ro.yezhuhao = true;
            continue;
          }
          if(o=='yezhuxingming'){
	    ...
	    this.ro.weixiugonghao = true;
          ...
          if(o=='shifuxingming'){
            this.ruleForm.shifuxingming = obj[o];
	    this.ro.shifuxingming = true;
            continue;
          }
          if(o=='shifushouji'){
            this.ruleForm.shifushouji = obj[o];
	    this.ro.shifushouji = true;
            continue;
          }
	    ...
	    this.ro.weixiujieguo = true;
          ...
          if(o=='huizhidan'){
            this.ruleForm.huizhidan = obj[o];
	    this.ro.huizhidan = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.shifuxingming!=''&&json.shifuxingming){
                this.ruleForm.shifuxingming = json.shifuxingming
	    		this.ro.shifuxingming = true;
		}
		if(json.shifushouji!=''&&json.shifushouji){
                this.ruleForm.shifushouji = json.shifushouji
	    		this.ro.shifushouji = true;
		}
        } else {
	...
	if(this.ruleForm.huizhidan!=null) {
		this.ruleForm.huizhidan = this.ruleForm.huizhidan.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `weixiuwancheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.weixiuwanchengCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    huizhidanUploadChange(fileUrls) {
	this.ruleForm.huizhidan = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
