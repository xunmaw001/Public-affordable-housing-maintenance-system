<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="业主手机" prop="yezhushouji">
          <el-input v-model="ruleForm.yezhushouji" 
              placeholder="业主手机" clearable  :readonly="ro.yezhushouji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="业主手机" prop="yezhushouji">
              <el-input v-model="ruleForm.yezhushouji" 
                placeholder="业主手机" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="完成状态" prop="wanchengzhuangtai">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="问题描述" prop="wentimiaoshu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wentimiaoshu" label="问题描述" prop="wentimiaoshu">
                    <span>{{ruleForm.wentimiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yezhuxingming = true;
          ...
          if(o=='yezhushouji'){
            this.ruleForm.yezhushouji = obj[o];
	    this.ro.yezhushouji = true;
            continue;
          }
          if(o=='loufanghao'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.yezhuhao!=''&&json.yezhuhao){
                this.ruleForm.yezhuhao = json.yezhuhao
	    		this.ro.yezhuhao = true;
		}
		if(json.yezhuxingming!=''&&json.yezhuxingming){
                this.ruleForm.yezhuxingming = json.yezhuxingming
	    		this.ro.yezhuxingming = true;
		}
		if(json.yezhushouji!=''&&json.yezhushouji){
                this.ruleForm.yezhushouji = json.yezhushouji
	    		this.ro.yezhushouji = true;
		}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `weixiushenbaodan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.weixiushenbaodanCrossAddOrUpdateFlag = false;
						 this.parent.search();
